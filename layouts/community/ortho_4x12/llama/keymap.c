...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       RCTL,  CAPS,  LGUI,  LALT,   SPC, NAV_S,                  NMS_S,   SPC, NMP_S, __X__, __X__, __X__  \
  /*`-----------------------------------------'                `-----------------------------------------.*/
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____,  LGUI, __X__,   INS,   DEL,   ENT,                    F11,   F12,  PSCR,  SLCK,  PAUS, _____, \
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, _____, _____, _____, _____, _____,                   BSLS,  MINS,  LBRC,  RBRC,  SCLN,  QUOT, \
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, _____, _____, _____, _____, _____,                    ENT,   EQL,  COMM,   DOT,  SLSH, _____, \
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
  ...
  //,-----------------------------------------.                ,-----------------------------------------.
      RESET, __X__, __X__, __X__, __X__, __X__,                  __X__, __X__, __X__, __X__, __X__, DEBUG, \
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      __X__, L_HUI, L_SAI, L_VAI, L_MOD, L_TOG,                  __X__, __X__, __X__, __X__, __X__, __X__, \
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
